...
```
<!-- FPI: toutes les API ne sont pas là ?-->
...
Following examples are provided in [STM32Examples](https://github.com/stm32duino/STM32Examples/tree/master/examples/Peripherals/HardwareTimer) library (available with Arduino Library manager).
